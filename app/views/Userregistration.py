...
def userlogin():
    ...
    if request.method =='POST':
        ...
        if (request.form["username"]=="admin01" and request.form["password"]=="admin2022"):
...
def userregister():
    ...
    if request.method == 'POST':
        ...
        print(request.form)
        User.objects.create(username=username,userpassword=userpassword,usermailid=usermailid,userrole=userrole,deliveryaddress=deliveryaddresslist,userphoneno=userphoneno)
